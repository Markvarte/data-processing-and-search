...
postings_dict = invertedIndexCreator.create_inverted_index(file_name='simple_sample.txt')
...
queryProcessor.process_query(postings_dict, query_file_name='querytest2.txt')
